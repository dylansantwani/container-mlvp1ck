...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-mlvp1ck.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-mlvp1ck.containers.anotherwebservice.com/
...
```
git clone git@github.com:dylansantwani/container-mlvp1ck.git
cd container-mlvp1ck
```
...
```
docker attach container-mlvp1ck
```
